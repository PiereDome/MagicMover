...
/***/ function(module, exports, __webpack_require__) {
	...
	var MagicMover = exports.MagicMover = _react2.default.createClass({
	  displayName: 'MagicMover',
	  ...
	  getChildrenPositions: function getChildrenPositions() {
	    var _this = this;
	  ...
	  addEndTransitionEvent: function addEndTransitionEvent() {
	  ...
	  cloneChildren: function cloneChildren(nextProps) {
	    var _this2 = this;
	    ...
	    _react2.default.Children.map(this.props.children, function (child) {
	      return _reactDom2.default.render(_react2.default.createElement(Clones, _extends({}, props, { positions: _this2.getChildrenPositions() })), _this2.portalNode);
	    });
	  },
	  cloneWithRefs: function cloneWithRefs() {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(this.props.component, { style: style }, this.cloneWithRefs());
	  }
	});
	...
	var Clones = _react2.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {},
	  cloneChildrenWithPositions: function cloneChildrenWithPositions() {
	    var _this3 = this;

	    return _react2.default.Children.map(this.props.children, function (child) {
	      var style = {};
	      // if(child.key){
	      var style = _this3.props.positions[child.key];
	      style.background = '#eee';
	      return _react2.default.cloneElement(child, { style: style, 'key': child.key });
	      // }
	    });
	  },
	  childrenWithPositions: function childrenWithPositions() {
	    ...
	    _react2.default.Children.forEach(this.props.children, function (child) {
	      if (child.key) {
	        var style = _this4.props.positions[child.key];
	        // style.background = '#'+Math.floor(Math.random()*16777215).toString(16);
	        var key = child.key;
	        children.push(_react2.default.cloneElement(child, { style: style, key: key }));
	      }
	    });
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(this.props.component, null, this.childrenWithPositions());
	  }
	});
